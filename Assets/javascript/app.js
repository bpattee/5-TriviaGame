...
// Royals trivia questions
var questions = [{
    question: "Who holds the Royals home run record with 38 long balls?",
    answerList: ["George Brett", "Jose Lima", "Mike Moustakas", "Billy Butler"],
    answer: 2
},{
    question: "Who was the first Royals pitcher to throw a no-hitter?",
    answerList: ["Brett Saberhagen", "Jose Lima", "Jim Bolborn", "Steve Busby"],
    answer: 3
},{
    question: "What was the first year the Royals played in Kauffman Stadium (formerly Royals Stadium)?",
    answerList: ["1973", "1970", "1965", "1977"],
    answer: 0
},{
    question: "Who was the Royals starting 3rd baseman in 2007?",
    answerList: ["Mike Moustakas", "David DeJesus", "Alex Gordon", "Billy Butler"],
    answer: 2
},{
    question: "What year did the Royals enter the MLB?",
    answerList: ["1967", "1970", "1965", "1969"],
    answer: 3
},{
    question: "What is the Royals mascot?",
    answerList: ["Sluggerrr", "BBQ Man", "Reggie the Royal", "Tom Selleck"],
    answer: 0
},{
    question: "When did the Royals first appear in a World Series?",
    answerList: ["1985", "1977", "2014", "1980"],
    answer: 3
}];
